...
def main():
    try:
        ...
        with app.app_context():
            ...
            print(f"   📧 Email: site.admin@trustv.local")
            print(f"   🔑 Senha: admin123")
            print(f"   👤 Nome: Site Admin")
            print(f"   🔐 Role: site_admin (acesso total ao sistema)")
            print(f"   🏢 Empresa: Nenhuma (acesso global)")
